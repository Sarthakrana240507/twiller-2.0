    ...
    <div className="w-80 p-4 space-y-4">
      ...
      <Card className="bg-gray-900 border-gray-800">
        <CardContent className="p-4">
          <h3 className="text-white text-xl font-bold mb-2">{t('subscribe_premium')}</h3>
      ...
      <div className="p-4 text-xs text-gray-500 space-y-2">
        <div className="flex flex-wrap gap-x-3 gap-y-1">
          <a href="#" className="hover:underline">{t('terms_service')}</a>
          <a href="#" className="hover:underline">{t('privacy_policy')}</a>
          <a href="#" className="hover:underline">{t('cookie_policy')}</a>
          <a href="#" className="hover:underline">{t('accessibility')}</a>
          <a href="#" className="hover:underline">{t('ads_info')}</a>
        </div>
        <div>© 2024 X Corp.</div>
      </div>
    </div>
